...
`inspect` 模式会同时解析并返回模型的官方参数规范（各参数类型、默认值、取值范围、必填项及文档链接）及 Runware 官方模型文档中公开的价格。搜索结果也会补充前 20 个模型的官方价格；页面未公开价格时不臆测。结果包含 AIR 标识符、名称、类别、架构、能力、来源、可见性、参数定义、价格与简介。
